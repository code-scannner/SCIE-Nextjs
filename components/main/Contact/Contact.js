                                                        ...
                                                        <div className="text-gray-500">
                                                            <div>
                                                                <ul className='flex space-x-5'>
                                                                    {this.socials.map((elem, ind) => <li key={ind} className="hover:scale-105 transition-[transform,color] text-xl sm:text-3xl text-pri-400 hover:text-pri-500 ring-2 ring-pri-200 hover:ring-pri-300 rounded-full p-1 sm:p-1.5">
